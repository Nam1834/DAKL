...
export class Migrations1745584665999 implements MigrationInterface {
    name = 'Migrations1745584665999'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "tutor_profiles" ADD "booking_request_id" character varying`);
    }
