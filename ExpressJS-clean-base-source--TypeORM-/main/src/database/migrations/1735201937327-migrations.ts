...
export class Migrations1735201937327 implements MigrationInterface {
    name = 'Migrations1735201937327'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "admins" ADD "status" character varying(30)`);
